...
| INV-RDM-050 | LEAK | HIGH | fraudReasons not included in scan response to clients | POST /api/stickers/scan, POST /api/stickers/scan/:scanId/receipt | stickers.routes.ts L208, L319 | [SUITE: LEAK] redemption-leak-050.test.ts |
