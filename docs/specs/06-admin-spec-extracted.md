...
**Currency Display Rule (Clash 12.1 — resolved 2026-08-20, BC-QA-031):**
...
| **12.1** | RESOLVED (2026-08-20, BC-QA-031): dual-currency display during the BGN→EUR transition window was implemented then removed once the transition ended. All amounts are EUR-only; no dual-currency machinery remains. |
