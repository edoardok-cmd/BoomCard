 ...
 *
 * Displayed when the user cancels payment or payment fails at Paysera.
 * Mirrors the website's /subscription/cancel page.
 * (Previously misnamed "SubscriptionCancelScreen" — this handles payment
 *  abandonment at the gateway, not subscription cancellation by the user.)
 */
...
const PaymentCancelledScreen = ({ navigation }: any) => {
