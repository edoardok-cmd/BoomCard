...
export const bg: TranslationKey = {
  ...
  partnerRegistration: {
    ...
    locateVenueOnMap: 'Намерете обекта на картата (натиснете „Намери на картата“)',
    invalidCoordinates: 'Невалидни координати',
    selectObjectCountRequired: 'Изберете брой обекти',
    invalidValue: 'Невалидна стойност',
    selectParticipationLevelRequired: 'Изберете ниво на участие',
    acceptPrivacyRequired: 'Трябва да приемете Политиката за поверителност',
    selectSubcategoryRequired: 'Изберете поне една подкатегория',
    venueLocation: 'Местоположение на обекта',
    numberOfVenues: 'Брой обекти',
    selectPlaceholder: '— Изберете —',
    qualification: 'Квалификация',
    participationLevel: 'Ниво на участие',
    basicParticipation: 'Базово участие',
    activeParticipation: 'Активно участие',
    strongGrowth: 'Силен растеж',
    additionalInfoSection: 'Допълнително',
    additionalInfoLabel: 'Допълнителна информация (по избор)',
    additionalInfoPlaceholder: 'Допълнителни бележки или контекст...',
    ...
    acceptTermsPrefix: '',
    termsLinkText: 'Общи условия',
    acceptTermsSuffix: ' — прочетох и приемам *',
    acceptPrivacyPrefix: '',
    privacyLinkText: 'Политика за поверителност',
    acceptPrivacySuffix: ' — прочетох и приемам *',
    marketingConsentLabel: 'Съгласявам се да получавам маркетингови съобщения (по избор)',
    applicationReviewNote: 'След изпращане на заявката, нашият екип ще се свърже с вас до 2 работни дни. При одобрение и завършен онбординг ще получите имейл с линк за активиране на акаунта и задаване на парола.',
  },
  ...
  errors: {
    ...
    tooManyRequests: 'Твърде много опити. Моля, изчакайте няколко минути и опитайте отново.',
  ...
  partners: {
    ...
    microTrust: 'Нашият екип ще се свърже с вас до 2 работни дни',
  ...
  checkoutPage: {
    ...
    errorLoadingPlan: 'Грешка при зареждане на плана',
    errorProcessingPayment: 'Грешка при обработка на плащането',
    requestFailedRetry: 'Заявката не може да бъде изпълнена. Опитайте отново.',
    loading: 'Зареждане...',
    backToPlans: 'Обратно към плановете',
    planNotFound: 'Планът не е намерен',
    billingPeriodUnavailable: 'Този план не предлага избрания период на плащане. Моля, изберете друг план или период.',
    firstNameLabel: 'Име',
    firstNamePlaceholder: 'Иван',
    lastNameLabel: 'Фамилия',
    lastNamePlaceholder: 'Иванов',
    emailAddressLabel: 'Имейл адрес',
    phoneOptionalLabel: 'Телефон (по избор)',
    enterValidEmail: 'Въведете валиден имейл',
    requiredField: 'Задължително поле',
    // 409 EMAIL_ALREADY_HAS_ACTIVE_PLAN — composed as prefix + <Link> + suffix
    emailConflictActivePlanPrefix: 'Имате активен абонамент за този имейл.',
    emailConflictActivePlanLinkText: 'Влезте в акаунта си',
    emailConflictActivePlanSuffix: 'за да го управлявате.',
    // 409 CHECKOUT_ALREADY_IN_PROGRESS — plain string, no link
    emailConflictInProgress: 'Плащане за този имейл вече е в процес. Моля, изчакайте малко и опитайте отново.',
    // 409 EMAIL_REGISTERED_NO_ACTIVE_PLAN (default conflict case) — prefix + <Link> + suffix
    emailConflictExistsPrefix: 'Акаунт с този имейл вече съществува.',
    emailConflictExistsLinkText: 'Влезте',
    emailConflictExistsSuffix: 'за да се абонирате.',
    redirecting: 'Пренасочване...',
    pay: 'Плати',
    or: 'или',
    alreadyHaveAccount: 'Вече имате акаунт?',
    logIn: 'Вход',
    secureRedirectNote: 'Ще бъдете пренасочени към избраната банка за сигурно плащане',
  ...
  subscriptionSuccessPage: {
    titleSuccess: 'Плащането е успешно!',
    ...
    timeoutWarning: 'Обработката отнема повече време от очакваното. Вашето плащане може да бъде все още в процес на обработка.',
    planLabel: 'План',
    ...
    monthly: 'Месечен',
    yearly: 'Годишен',
    checkInbox: 'Провери входящата си поща',
    // Anonymous/guest checkout follow-up email — email interpolated between prefix/suffix
    setupLinkSentPrefix: 'Изпратихме линк до',
    setupLinkSentSuffix: ' за завършване на акаунта ти.',
    setupLinkSentGeneric: 'Изпратихме ти имейл с линк за завършване на акаунта.',
    linkExpires: 'Линкът е валиден 30 минути.',
    goToDashboard: 'Към Профила',
  ...
  completeProfilePage: {
    ...
    invalidLinkMessage: 'Този линк не е валиден. Моля, свържете се с поддръжката.',
    goToLogin: 'Към вход',
    passwordComplexity: 'Паролата трябва да съдържа главна, малка буква, цифра и специален символ',
    accountCreatedTitle: 'Акаунтът е създаден!',
    accountCreatedMessage: 'Твоят BoomCard акаунт е готов. Влез от мобилното приложение, за да използваш абонамента си.',
    goToBoomCard: 'Отиди към BoomCard',
    setPasswordTitle: 'Задай парола',
    setPasswordSubtitle: 'Избери парола за твоя BoomCard акаунт',
    // 409 conflict — prefix + <Link> (no suffix)
    emailConflictPrefix: 'Акаунт с този имейл вече съществува.',
    emailConflictLinkText: 'Влезте тук',
    passwordPlaceholder: 'Поне 8 символа, главна, малка, цифра, символ',
    marketingConsentEmail: 'Съгласявам се да получавам маркетингови имейли от BoomCard (по избор)',
    marketingConsentPhone: 'Съгласявам се да получавам маркетингови съобщения по телефон от BoomCard (по избор)',
    saving: 'Запазване...',
    activateAccount: 'Активирай акаунта',
  },
};
