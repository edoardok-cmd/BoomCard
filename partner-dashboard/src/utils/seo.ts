...
const DEFAULT_SEO_BG: SEOConfig = {
  title: 'BoomCard - Отстъпки, Изживявания, Карта за Намаления',
  description: 'Открийте ексклузивни отстъпки и топ изживявания с вашата BoomCard карта за намаления. Подарете си незабравими преживявания!',
  keywords: [
    'отстъпки', 'изживявания', 'карта за намаления', 'ексклузивни отстъпки',
    'подарък', 'топ изживявания', 'отстъпки', 'България', 'София',
    'Пловдив', 'Варна', 'отстъпки ресторанти', 'отстъпки хотели'
  ],
  image: '/og-image.png',
  type: 'website',
  language: 'bg',
