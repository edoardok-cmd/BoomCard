...
const CATEGORIES_WITH_SUBS: { value: string; label: string; subcategories: string[] }[] = [
  { value: 'Ресторанти и заведения', label: 'Ресторанти и заведения', subcategories: ['Ресторанти', 'Кафенета', 'Барове и пъбове', 'Бистра', 'Пицарии', 'Морска кухня', 'Азиатска кухня', 'Скара и месо', 'Вегетарианска'] },
  { value: 'Настаняване', label: 'Настаняване', subcategories: ['Хотели', 'Хостели', 'Къщи за гости', 'Апартаменти', 'Вили', 'Бутик хотели', 'B&B', 'Курортни комплекси'] },
  { value: 'Клубове и нощен живот', label: 'Клубове и нощен живот', subcategories: ['Нощни клубове', 'Барове', 'Лаундж', 'Казина', 'Karaoke'] },
  { value: 'СПА и уелнес', label: 'СПА и уелнес', subcategories: ['СПА центрове', 'Масажи', 'Йога', 'Медитация', 'Термални бани', 'Халотерапия', 'Аквапаркове'] },
  { value: 'Красота и грижа', label: 'Красота и грижа', subcategories: ['Фризьорски салони', 'Козметични салони', 'Маникюр и педикюр', 'Студия за красота', 'Татуировки'] },
  { value: 'Спорт и фитнес', label: 'Спорт и фитнес', subcategories: ['Фитнес зали', 'Плуване', 'Тенис', 'Боулинг', 'Картинг', 'Скалодром', 'Йога студио', 'Бойни изкуства'] },
  { value: 'Приключения', label: 'Приключения', subcategories: ['Рафтинг', 'Парапланеризъм', 'Конна езда', 'Пейнтбол', 'ATV и офроуд', 'Планински туризъм', 'Скачане с парашут'] },
  { value: 'Вино и дегустации', label: 'Вино и дегустации', subcategories: ['Винарни', 'Дегустации', 'Кулинарни класове', 'Пивоварни', 'Уиски дегустации'] },
  { value: 'Пазаруване', label: 'Пазаруване', subcategories: ['Мода и облекло', 'Бижута и аксесоари', 'Подаръци', 'Козметика', 'Спортни стоки', 'Антики'] },
  { value: 'Культура и изкуство', label: 'Культура и изкуство', subcategories: ['Музеи', 'Галерии', 'Театри', 'Кина', 'Концертни зали'] },
  { value: 'Транспорт и туризъм', label: 'Транспорт и туризъм', subcategories: ['Туристически агенции', 'Трансфери', 'Коли под наем', 'Яхти и лодки'] },
  { value: 'Медицина и здраве', label: 'Медицина и здраве', subcategories: ['Частни клиники', 'Зъболекари', 'Оптики', 'Аптеки', 'Ветеринари'] },
  { value: 'Образование', label: 'Образование', subcategories: ['Езикови школи', 'Курсове', 'Семинари', 'Онлайн обучение'] },
  { value: 'Друго', label: 'Друго', subcategories: ['Разни', 'Услуги', 'Технологии'] },
];
