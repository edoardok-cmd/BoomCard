  ...
  const faqs = language === 'bg' ? [
    {
      ...
      a: 'BoomCard ви предоставя достъп до ексклузивни кешбек отстъпки в стотици места в България. Изберете партньор, сканирайте BOOM стикера на масата, поръчайте, платете сметката и снимайте касовата бележка чрез приложението. Кешбекът се кредитира автоматично след проверка.'
    },
    {
