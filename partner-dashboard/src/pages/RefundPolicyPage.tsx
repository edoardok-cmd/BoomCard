          ...
          {language === 'bg' ? (
            <>
              ...
              <ul>
                ...
                <li><strong>Условие:</strong> Ако сте използвали услуги с добавена стойност (кешбек, отстъпки на Партньори) през 14-те дни, може да бъде приспаднат пропорционален размер на стойността на използваните услуги.</li>
