          ...
          <div className="text-center mb-16">
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '0.25rem' }}>
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg
                    ...
                    height="24"
                    viewBox="0 0 20 20"
                    fill={star <= Math.round(reviewStats?.averageRating > 0 ? reviewStats.averageRating : 4.9) ? '#fbbf24' : '#d1d5db'}
                  >
              ...
              <span style={{
                ...
                {reviewStats?.averageRating > 0 ? reviewStats.averageRating.toFixed(1) : '4.9'}/5
              </span>
              <span style={{
                color: 'var(--color-text-secondary)',
                fontSize: '1rem'
