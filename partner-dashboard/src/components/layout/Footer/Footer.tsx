...
const FooterSection: React.FC<{
  ...
  return (
    <div className="border-b border-gray-700 md:border-none">
      <button
        className="flex justify-between items-center w-full py-4 md:cursor-default"
        onClick={() => setIsOpen(!isOpen)}
      >
        <h4 className="font-semibold text-white text-left">{title}</h4>
        <svg
      ...
      <div className={`pb-4 md:block ${isOpen ? 'block' : 'hidden'}`}>
        {children}
      </div>
    </div>
  );
          ...
          <FooterSection title={t('footer.social')}>
            <div className="flex flex-col space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors text-base"
              >
