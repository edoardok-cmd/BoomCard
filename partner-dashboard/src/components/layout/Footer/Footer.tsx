...
const FooterSection: React.FC<{
  ...
  return (
    <div className="border-b border-gray-700 md:border-none">
      <button
        className="flex justify-between items-center w-full py-4 md:cursor-default md:pointer-events-none"
        onClick={() => setIsOpen(!isOpen)}
        aria-expanded={isOpen}
        aria-label={`Toggle ${title} menu`}
      >
        <h4 className="font-semibold text-white text-left text-base md:text-lg">{title}</h4>
        <svg
          className={`w-5 h-5 text-white transition-transform duration-300 ease-in-out md:hidden ${isOpen ? 'rotate-180' : ''}`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-0 md:gap-12 lg:gap-16 mb-8">
          ...
          <FooterSection title={t('footer.company')}>
            <ul className="space-y-2.5 md:space-y-3 text-sm md:text-base">
              ...
              <li><Link to="/support" className="text-gray-300 hover:text-white transition-colors">{t('footer.support')}</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-white transition-colors">{t('footer.reportProblem')}</Link></li>
          ...
          <FooterSection title={t('footer.social')}>
            <div className="flex flex-col space-y-3">
              <a
                href="https://facebook.com/boomcard"
                target="_blank"
              ...
              <a
                href="https://instagram.com/boomcard"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors text-sm md:text-base"
              >
              ...
              <a
                href="https://linkedin.com/company/boomcard"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors text-sm md:text-base"
              >
              ...
              <a
                href="https://twitter.com/boomcard"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors text-sm md:text-base"
              >
