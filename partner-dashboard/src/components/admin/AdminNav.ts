...
export const ADMIN_NAV: AdminNavCategory[] = [
  ...
  },
  {
    ...
    subItems: [
      { labelBg: 'Преглед на риска', labelEn: 'Risk Review', path: '/admin/control/risk', permissionKey: 'control.risk.read' },
      { labelBg: 'Сигурност', labelEn: 'Security', path: '/admin/control/security', permissionKey: 'control.risk.read' },
  ...
  },
  {
    ...
    subItems: [
      ...
      { labelBg: 'Одит лог', labelEn: 'Audit Log', path: '/admin/admins/audit', permissionKey: 'admins.audit.read' },
    ],
  },
  {
    key: 'help',
  ...
  },
  {
    ...
    subItems: [
      { labelBg: 'Моите данни', labelEn: 'My Data', path: '/admin/profile/my-data' },
      { labelBg: 'Сигурност', labelEn: 'Security', path: '/admin/profile/security' },
    ],
  },
];
