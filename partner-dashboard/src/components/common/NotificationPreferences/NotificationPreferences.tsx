...
const content = {
  en: {
    ...
    status: {
      granted: 'You will receive notifications about new discounts, updates, and messages.',
      denied: 'Notifications are blocked. Please enable them in your browser settings.',
      default: 'Enable notifications to get real-time updates about discounts and activities.',
    },
    ...
    types: {
      ...
      newOffersDesc: 'Get notified when new discounts are available',
      expiringOffers: 'Expiring Discounts',
      expiringOffersDesc: 'Reminders before your discounts expire',
      ...
      promotions: 'Marketing Updates',
      promotionsDesc: 'General marketing messages, discounts, and news',
    },
  ...
  bg: {
    ...
    status: {
      granted: 'Ще получавате известия за нови отстъпки, актуализации и съобщения.',
      denied: 'Известията са блокирани. Моля разрешете ги от настройките на браузъра.',
      default: 'Разрешете известия за актуализации в реално време за отстъпки и активности.',
    },
    ...
    types: {
      ...
      newOffersDesc: 'Получавайте известия за нови отстъпки',
      expiringOffers: 'Изтичащи Отстъпки',
      expiringOffersDesc: 'Напомняния преди да изтекат отстъпките',
      ...
      promotions: 'Маркетингови съобщения',
      promotionsDesc: 'Общи маркетингови съобщения, отстъпки и новини',
    },
