      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              label: 'Mehana (Tavern)',
              labelBg: 'Механа',
              path: '/venues/restaurants?type=mehana',
            },
            {
              id: 'vegetarian-vegan',
            ...
            {
              id: 'foreign',
              label: 'Foreign Cuisine',
              labelBg: 'Чуждестранна кухня',
              path: '/venues/restaurants?type=foreign',
              children: [
                {
                  id: 'fine-dining',
                  label: 'Fine Dining',
                  labelBg: 'Фино хранене',
                  path: '/venues/restaurants?type=fine-dining',
                },
                {
                  id: 'seafood',
                  label: 'Seafood',
                  labelBg: 'Морска храна',
                  path: '/venues/restaurants?type=seafood',
                },
                {
                  id: 'pizza-italian',
                  label: 'Pizza & Italian',
                  labelBg: 'Пица и италианска кухня',
                  path: '/venues/restaurants?type=pizza-italian',
                },
                {
                  id: 'asian',
                  label: 'Asian Cuisine',
                ...
                },
                {
                  id: 'bbq-grill',
                  label: 'BBQ & Grill',
                  labelBg: 'Барбекю и скара',
                  path: '/venues/restaurants?type=bbq-grill',
                },
                {
                  id: 'steakhouse',
                  label: 'Steakhouse',
                  labelBg: 'Стейкхаус',
                  path: '/venues/restaurants?type=steakhouse',
                },
                {
                  id: 'sushi',
                  label: 'Sushi',
                  labelBg: 'Суши',
                  path: '/venues/restaurants?type=sushi',
                },
              ],
            },
          ],
