...
const sampleVenues = [
  ...
  },
  {
    name: 'Mamma Mia',
    nameBg: 'Мама Миа',
    address: 'ul. "Tsar Ivan Shishman" 39',
    city: 'Sofia',
    region: 'Sofia City',
    latitude: 42.69245,
    longitude: 23.33095,
    phone: '+359 2 981 2727',
    email: 'info@mammamia.bg',
    description: 'Authentic Italian restaurant with homemade pasta',
    descriptionBg: 'Автентичен италиански ресторант с домашна паста',
    images: JSON.stringify(['/images/venues/mammamia-1.jpg']),
    openingHours: JSON.stringify({
      monday: '11:00-00:00',
      tuesday: '11:00-00:00',
  ...
  },
  {
    name: 'Bar Bar',
    nameBg: 'Бар Бар',
    address: 'ul. "6-ti Septemvri" 7, Sofia Center',
    city: 'Sofia',
    region: 'Sofia City',
    latitude: 42.6968,
    longitude: 23.3215,
    phone: '+359 2 945 3210',
    email: 'contact@barbar.bg',
    description: 'Trendy cocktail bar with live DJ sets',
    descriptionBg: 'Модерен коктейл бар с DJ сетове на живо',
    images: JSON.stringify(['/images/venues/barbar-1.jpg']),
    openingHours: JSON.stringify({
      monday: 'Closed',
      tuesday: '17:00-02:00',
    ...
    capacity: 50,
    features: JSON.stringify(['WiFi', 'Live Music', 'Cocktails', 'Late Night']),
  },
  {
    name: 'Pizza Lab',
    nameBg: 'Пица Лаб',
    address: 'ul. "Graf Ignatiev" 44',
    city: 'Sofia',
    region: 'Sofia City',
    latitude: 42.68982,
    longitude: 23.32689,
    phone: '+359 2 963 8888',
    email: 'orders@pizzalab.bg',
    description: 'Experimental pizza kitchen with unique flavor combinations',
    descriptionBg: 'Експериментална пицария с уникални вкусови комбинации',
    images: JSON.stringify(['/images/venues/pizzalab-1.jpg']),
    openingHours: JSON.stringify({
      monday: '11:00-22:00',
      tuesday: '11:00-22:00',
    ...
    capacity: 45,
    features: JSON.stringify(['WiFi', 'Delivery', 'Takeout', 'Craft Beer', 'Outdoor Seating']),
  },
  {
    name: "Gentlemen's Roastery Lab",
    nameBg: 'Gentlemen\'s Roastery Lab',
    address: 'ul. "Tsar Shishman" 39, Sofia Center',
    city: 'Sofia',
    region: 'Sofia City',
    latitude: 42.689495,
    longitude: 23.32797,
    phone: '+359 2 987 6543',
    email: 'info@gentlemensroasterylab.bg',
    description: 'Specialty coffee roastery and café with artisan coffee',
    descriptionBg: 'Специализирана кафеобжарна и кафе с занаятчийско кафе',
    images: JSON.stringify(['/images/venues/gentlemens-1.jpg']),
    openingHours: JSON.stringify({
      monday: '08:00-20:00',
      tuesday: '08:00-20:00',
    ...
    capacity: 30,
    features: JSON.stringify(['WiFi', 'Specialty Coffee', 'Outdoor Seating', 'Pet Friendly']),
  },
